...
> 为 PHOENIX 自进化 AI Agent 系统打造的现代化设计语言

---

## 概述

PHOENIX AIOS 设计系统提供了一套完整的设计规范和组件库，用于构建专业、智能、克制的 AI Agent 界面。
...
design-system/
├── README.md                          # 本文件
├── phoenix-design-system.md           # 完整设计规范
